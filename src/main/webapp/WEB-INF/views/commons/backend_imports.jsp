...
<!-- Theme style -->
<link rel="stylesheet"
	href="<c:url value='/Sources/Sources/dist/css/adminlte.min.css' />">
<!-- Select2 -->
<link rel="stylesheet"
...
<!-- JQVMap -->
<script src="<c:url value='/Sources/plugins/jqvmap/jquery.vmap.min.js' />"></script>
<script src="<c:url value='/Sources/plugins/jqvmap/maps/jquery.vmap.usa.js' />"></script>
<!-- jQuery Knob Chart -->
<script src="<c:url value='/Sources/plugins/jquery-knob/jquery.knob.min.js' />"></script>
<!-- daterangepicker -->
<script src="<c:url value='/Sources/plugins/moment/moment.min.js' />"></script>
<script src="<c:url value='/Sources/plugins/daterangepicker/daterangepicker.js' />"></script>
<!-- Tempusdominus Bootstrap 4 -->
<script
	src="<c:url value='/Sources/plugins/tempusdominus-bootstrap-4/js/tempusdominus-bootstrap-4.min.js' />"></script>
<!-- Summernote -->
<script src="<c:url value='/Sources/plugins/summernote/summernote-bs4.min.js' />"></script>
<!-- overlayScrollbars -->
<script
	src="<c:url value='/Sources/plugins/overlayScrollbars/js/jquery.overlayScrollbars.min.js' />"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<c:url value='/Sources/dist/js/pages/dashboard.js' />"></script>
