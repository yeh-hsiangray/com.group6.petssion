...
<div align='center'>
<h3>會員資料</h3>
<a href='mem'>新增會員資料</a> &nbsp;&nbsp;&nbsp;<a href="<c:url value='/mod06'/> " >回Mod06首頁</a>	
<hr>
<form method='POST'>
		...
		<table border='1' cellpadding="3" cellspacing="1" >
			...
			<c:forEach var='member' items='${members}'>
				<tr>
					...
					<td><img width='60' height='72' src='picture/${member.id}' /></td>
					 <td><a
                        href="<c:url value='/' />mod06/_02_member/mem/${member.id}">編輯</a></td>
                    <td><a class='deletelink'
                        href="<c:url value='/' />mod06/_02_member/mem/${member.id}">刪除</a></td>
				</tr>
			</c:forEach>
		</table>
	</c:otherwise>
