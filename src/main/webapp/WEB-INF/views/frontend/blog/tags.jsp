...
<body>
			...
			<div class="row d-flex align-items-center justify-content-center">
				<div class="about-content col-lg-12">
					...
					<p class="text-white link-nav" style="font-size:20px">
						<a href="<c:url value='/frontend/blog/index'/>"  style="font-size:20px">寵物專欄</a> <span
							class="lnr lnr-arrow-right"></span><a
							href="<c:url value='/frontend/blog/index'/>"  style="font-size:20px">文章分類</a> <span
							class="lnr lnr-arrow-right"></span> <a href="#" style="font-size:20px"> ${tag}</a>
					</p>
				</div>
			</div>
		</div>
	...
	<script>
		...
		function getPageData(page) {
			...
			$("ul.pagination").empty();
			$.ajax({
				url : "<c:url value='/frontend/blog/api/tagArticle'/>"
						+ "?page=" + page + "&size=" + pageSize+"&tag=${tag}",
				method : 'GET',
								...
								<div class="col-lg-3  col-md-3 meta-details">
									<ul class="tags">
										...
										<p class="view col-lg-12 col-md-12 col-6">
											<a href="#">觀看次數</a> <span class="lnr lnr-eye"></span>
										</p>
