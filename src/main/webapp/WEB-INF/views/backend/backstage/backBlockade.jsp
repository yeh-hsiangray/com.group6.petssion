                ...
                fetch("select", { method: "POST", body: JSON.stringify(data), headers: { "Content-Type": "application/json" } }).
                    ...
                    (function (data) {
                        ...
                        con = `<table class='table table-striped'><thead><tr><th scope='col'>帳號</th>  <th scope='col'>姓名</th><th scope='col'>生日</th><th scope='col'>信箱</th><th scope='col'>性別</th><th scope='col'>職業</th><th scope='col'>停權</th><th scope='col'> </th></tr></thead><tbody>`
                            ...
                            dataIndex=0
                            dataEnd=5
                            if(data.number>2&&data.number<data.totalPages-4){
