...
2. Logo / Brand Link
  - `<a href="index3.html" class="brand-link"><img src="dist/img/PetssionLogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8"><span class="brand-text font-weight-light">AdminLTE 3</span></a>` replaces the old logo
3. Sidebar
